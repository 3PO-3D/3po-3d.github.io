...
<section class="creator-skills">
  <div class="container">
    ...
    <p class="lead" style="max-width:560px;color:var(--muted);">
      I'm wired to go 110% on things that interest me, or not at all. That's led to an unusually wide range.
      For a freelancer, that's the point.
    </p>
...
<section class="creator-arc">
  <div class="container">
    ...
    <div class="arc-list">
      <div class="arc-item">
        <span class="arc-year">2016 – 2021</span>
        <div class="arc-content">
          <p>Studied chemistry at the University of Szeged. Got very good at thinking in systems, tolerances, and why things fail.</p>
        </div>
      </div>
      <div class="arc-item">
        <span class="arc-year">2020</span>
        <div class="arc-content">
          <p>Taught myself Java at Flow Academy. Discovered that code is just chemistry with fewer explosions and more semicolons.</p>
        </div>
      </div>
      <div class="arc-item">
      ...
      <div class="arc-item">
        <span class="arc-year">2023 – now</span>
        <div class="arc-content">
          <p>Founded 3PO. Built CHRONOS — a scene variation management plugin for Cinema 4D that I wanted to exist and didn't. Shipped it. Still improving it. Working on what comes next.</p>
        </div>
      </div>
    </div>
  </div>
