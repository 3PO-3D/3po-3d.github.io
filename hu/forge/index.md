...
footer_tagline: "FORGE · FDM Nyomtatóműhely"
title: "FORGE — 3PO 3D Nyomtatás"
description: "Nagyméretű FDM 3D nyomtatás, utómunka és 3D szkennelés. Funkcionális alkatrészek, prototípusok, egyedi megrendelések és testre szabott ortopéd talpbetétek."
permalink: /hu/forge/
---
...
<section class="hero hero-grid-bg">
  <div class="container">
    ...
    <div class="hero-meta">
      ...
      <div class="stat"><div class="n">Szkenn&nbsp;→&nbsp;Alkatrész</div><div class="l">teljes folyamat</div></div>
      <div class="stat"><div class="n">1&ndash;5&nbsp;nap</div><div class="l">jellemző átfutás</div></div>
    </div>
  </div>
</section>
...
<section class="section">
  <div class="container">
    <div class="order-band">
      <div>
        <p class="ob-label">Kiemelt — Egyedi talpbetétek</p>
        <h3>3D-nyomtatott talpbetétek, a lábszkenned alapján.</h3>
        <p>Ortopéd vagy kényelmi, rugalmas TPU-ból. Rendelj most, töltsd fel a lábszkenned, és amint a számla rendezve van, a párt méretre nyomtatom és kiszállítom.</p>
      </div>
      <div class="hero-cta" style="margin:0;">
        <a href="{{ '/hu/forge/products/' | relative_url }}" class="btn btn-accent">Talpbetétek megtekintése</a>
      </div>
    </div>
  </div>
</section>
